#!usr/bin/env python3
"""
DFS, BFS, A* Search Algorithms
Sachin Jadhav
Maze GUI for use with search algorithms with ability to post the target
"""
...
if __name__ == "__main__":
    maze_grid, maze_dimensions, maze_obstacles, player_start_pos, opponent_start_pos = helpers.read_maze_from_file(
        config.MAZE_FILE)
    gui = MazeGUI(maze_grid, maze_dimensions, maze_obstacles, opponent_start_pos)
    turtle.mainloop()